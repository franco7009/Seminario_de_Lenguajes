...
cadena = """NumPy is the fundamental package for scientific computing with Python.
...
c = Counter(cadena.lower().split(" "))
print(f"Palabra mas frecuente {c.most_common(1)[0][0]}")

print(Counter(cadena.lower().split(" ")).most_common(1)[0][0])
